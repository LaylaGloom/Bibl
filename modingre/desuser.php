...
if ( ! empty($_GET))
{
	...
	{	
		echo "<script>
				...
				document.location.href='desuser.php';
	...
	{	
		...
		$desh = $conn->prepare("UPDATE client SET status_People_id = ? WHERE id =?");
		...
		switch (clr)
		  {
			case 1:
				...
				localStorage.ini=0;
				localStorage.pag=12;
				window.location.href='desuser.php?regv='+reg_pag+'&regi='+reg_ini
				break;
			case 2:
...
<?php }?>
    ...
    <div class="der">Codificacion 1:->Habilitado 3:->Deshabilitado </div>
  </div>
